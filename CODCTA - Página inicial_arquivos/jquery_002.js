...
!(function (e, t) {
  ...
  (d.filter = function (e, t, n) {
    ...
    d.fn.extend({
      find: function (e) {
        ...
        return (
          ((n = this.pushStack(i > 1 ? d.unique(n) : n)).selector = this
            .selector
            ? this.selector + " " + e
            : e),
          n
      ...
      is: function (e) {
        return !!E(this, "string" == typeof e && w.test(e) ? d(e) : e || [], !1)
          .length;
      },
    });
  var N,
    ...
    if (((n = n || N), "string" == typeof e)) {
      ...
      if (i[1]) {
        if (
          ...
          d.merge(
            this,
            d.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : r, !0)
          ),
    ...
    closest: function (e, t) {
      for (
        var n,
          ...
          i = this.length,
          o = [],
          a = w.test(e) || "string" != typeof e ? d(e, t || this.context) : 0;
        r < i;
        r++
      )
      ...
      function (e, t) {
        d.fn[e] = function (n, r) {
          ...
          return (
            ...
            this.length > 1 &&
              (A[e] || (i = d.uniqueSort(i)), S.test(e) && (i = i.reverse())),
            this.pushStack(i)
          );
        };
      }
  ...
  function q() {
    r.addEventListener
      ...
      : (r.detachEvent("onreadystatechange", _), e.detachEvent("onload", _));
  }
  function _() {
    (r.addEventListener ||
      "load" === e.event.type ||
              ...
              (function t(n) {
                d.each(n, function (n, r) {
                  d.isFunction(r)
                    ...
                    : r && r.length && "string" !== d.type(r) && t(r);
                });
              })(arguments),
              n && !t && u()),
            this
    ...
    ready: function (e) {
      (!0 === e ? --d.readyWait : d.isReady) ||
        ...
        (!0 !== e && --d.readyWait > 0) ||
          (j.resolveWith(r, [d]),
          d.fn.triggerHandler &&
            (d(r).triggerHandler("ready"), d(r).off("ready"))));
    },
  }),
      ...
      if (
        ...
        return (
          ...
          ("object" != typeof t && "function" != typeof t) ||
            (i
              ? (l[c] = d.extend(l[c], t))
              : (l[c].data = d.extend(l[c].data, t))),
          (a = l[c]),
          i || (a.data || (a.data = {}), (a = a.data)),
          void 0 !== r && (a[d.camelCase(t)] = r),
          "string" == typeof t
            ? null == (o = a[t]) && (o = a[d.camelCase(t)])
            : (o = a),
          o
        );
    }
          ...
          if (
            ...
            for (n = a.length; n--; )
              a[n] &&
                ...
                P(o, (r = d.camelCase(r.slice(5))), i[r]);
  ...
  function ce(e, t, n, r, i) {
    for (
      var o, a, s, u, l, c, p, h = e.length, g = re(t), m = [], v = 0;
      v < h;
      v++
    )
      if ((a = e[v]) || 0 === a)
        if ("object" === d.type(a)) d.merge(m, a.nodeType ? [a] : a);
          ...
          if (
            (!f.leadingWhitespace &&
              te.test(a) &&
              m.push(t.createTextNode(te.exec(a)[0])),
            !f.tbody)
          )
            for (
              o =
              ...
              d.nodeName((c = a.childNodes[o]), "tbody") &&
                !c.childNodes.length &&
                a.removeChild(c);
  ...
  (d.event = {
          ...
          n.handler && ((n = (u = n).handler), (i = u.selector)),
            ...
            (c = v.handle) ||
              ((c = v.handle = function (e) {
                return void 0 === d || (e && d.event.triggered === e.type)
                  ? void 0
    ...
    trigger: function (t, n, i, o) {
      ...
      if (
        ...
        3 !== i.nodeType &&
          ...
          ((t = t[d.expando]
            ? t
            : new d.Event(m, "object" == typeof t && t)).isTrigger = o ? 2 : 3),
          (t.namespace = v.join(".")),
        ...
        if (!o && !f.noBubble && !d.isWindow(i)) {
          for (
            l = f.delegateType || m, he.test(l + m) || (u = u.parentNode);
            u;
            u = u.parentNode
          )
            g.push(u), (p = u);
        ...
        for (h = 0; (u = g[h++]) && !t.isPropagationStopped(); )
          (t.type = h > 1 ? l : f.bindType || m),
            (a =
              (d._data(u, "events") || {})[t.type] && d._data(u, "handle")) &&
              a.apply(u, n),
            (a = s && u[s]) &&
              a.apply &&
              M(u) &&
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          s = d.event.handlers.call(this, e, l), t = 0;
          ...
          for (
            ...
            (e.rnamespace && !e.rnamespace.test(a.namespace)) ||
              ...
              void 0 !==
                (r = (
                  (d.event.special[a.origType] || {}).handle || a.handler
                ).apply(o.elem, u)) &&
                !1 === (e.result = r) &&
      ...
      (d.event.special.submit = {
        ...
        postDispatch: function (e) {
          e._submitBubble &&
            ...
            this.parentNode &&
              !e.isTrigger &&
              d.event.simulate("submit", this.parentNode, e));
        },
        teardown: function () {
          if (d.nodeName(this, "form")) return !1;
            ...
            fe.test(t.nodeName) &&
              ...
              (d.event.add(t, "change._change", function (e) {
                !this.parentNode ||
                  e.isSimulated ||
                  e.isTrigger ||
                  d.event.simulate("change", this.parentNode, e);
              }),
              d._data(t, "change", !0));
          });
        },
      ...
      d.each({ focus: "focusin", blur: "focusout" }, function (e, t) {
        ...
        d.event.special[t] = {
          ...
          teardown: function () {
            ...
            i
              ? d._data(r, t, i)
              : (r.removeEventListener(e, n, !0), d._removeData(r, t));
          },
        };
      }),
    d.fn.extend({
  ...
  function qe(e, t, n, r) {
    ...
    if (
      h &&
      ((i = (c = ce(t, e[0].ownerDocument, !1, e, r)).firstChild),
      ...
      for (s = (u = d.map(oe(c, "script"), De)).length; p < h; p++)
        (a = c),
          p !== g &&
            ((a = d.clone(a, !0, !0)), s && d.merge(u, oe(a, "script"))),
          n.call(e[p], a, p);
      if (s)
  ...
  function _e(e, t, n) {
    for (var r, i = t ? d.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || d.cleanData(oe(r)),
        r.parentNode &&
          (n && d.contains(r.ownerDocument, r) && ae(oe(r, "script")),
  ...
  d.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        (f.html5Clone || d.isXMLDoc(e) || !we.test("<" + e.nodeName + ">")
          ? (o = e.cloneNode(!0))
        ...
        for (r = oe(o), s = oe(e), a = 0; null != (i = s[a]); ++a)
          r[a] && He(i, r[a]);
      if (t)
        if (n)
      ...
      return (
        (r = oe(o, "script")).length > 0 && ae(r, !u && oe(e, "script")),
        (r = s = i = null),
        o
      );
    },
        ...
        return Q(
          ...
          function (e) {
            ...
            if (
              "string" == typeof e &&
              !Ce.test(e) &&
              (f.htmlSerialize || !we.test(e)) &&
              (f.leadingWhitespace || !te.test(e)) &&
              !ie[(Z.exec(e) || ["", ""])[1].toLowerCase()]
            ) {
              e = d.htmlPrefilter(e);
              try {
                for (; n < r; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (d.cleanData(oe(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return qe(
          ...
          function (t) {
            ...
            d.inArray(this, e) < 0 &&
              (d.cleanData(oe(this)), n && n.replaceChild(t, this));
          },
          e
        );
      },
    ...
    return (
      n ||
        (("none" !== (n = Oe(e, t)) && n) ||
          ((t = (
            (Fe = (
              Fe || d("<iframe frameborder='0' width='0' height='0'/>")
  ...
  e.getComputedStyle
    ? (($e = function (t) {
      ...
      (ze = function (e, t, n) {
        ...
        return (
          ("" !==
            (a = (n = n || $e(e)) ? n.getPropertyValue(t) || n[t] : void 0) &&
            void 0 !== a) ||
      ...
      (r = e[a]).style &&
        ...
        t
          ? (o[a] || "none" !== n || (r.style.display = ""),
            "" === r.style.display &&
              U(r) &&
              (o[a] = d._data(r, "olddisplay", Re(r.nodeName))))
          : ((i = U(r)),
            ((n && "none" !== n) || !i) &&
              d._data(r, "olddisplay", i ? n : d.css(r, "display"))));
    for (a = 0; a < s; a++)
      (r = e[a]).style &&
  ...
  function it(e, t, n, r, i) {
    for (
      ...
      "margin" === n && (a += d.css(e, n + X[o], !0, i)),
        r
          ? ("content" === n && (a -= d.css(e, "padding" + X[o], !0, i)),
            "margin" !== n && (a -= d.css(e, "border" + X[o] + "Width", !0, i)))
          : ((a += d.css(e, "padding" + X[o], !0, i)),
            "padding" !== n &&
              (a += d.css(e, "border" + X[o] + "Width", !0, i)));
    return a;
  }
  function ot(e, t, n) {
    var r = !0,
    ...
    if (i <= 0 || null == i) {
      if (
        (((i = ze(e, t, o)) < 0 || null == i) && (i = e.style[t]), Be.test(i))
      )
        return i;
          ...
          return rt(
            ...
            r
              ? it(
                  ...
                  t,
                  r,
                  f.boxSizing && "border-box" === d.css(e, "boxSizing", !1, i),
                  i
                )
              : 0
          );
  ...
  function ht(e, t, n) {
    ...
    for (
      ...
      if ((r = ht.prefilters[o].call(l, e, c, l.opts)))
        return (
          d.isFunction(r.stop) &&
            (d._queueHooks(l.elem, l.opts.queue).stop = d.proxy(r.stop, r)),
          r
        );
    return (
      d.map(c, pt, l),
    ...
    prefilters: [
      function (e, t, n) {
        ...
        1 === e.nodeType &&
          ...
          "inline" ===
            ("none" === (l = d.css(e, "display"))
              ? d._data(e, "olddisplay") || Re(e.nodeName)
              : l) &&
            "none" === d.css(e, "float") &&
            (f.inlineBlockNeedsLayout && "inline" !== Re(e.nodeName)
              ? (h.zoom = 1)
        ...
        if (d.isEmptyObject(p))
          "inline" === ("none" === l ? Re(e.nodeName) : l) && (h.display = l);
        else
          for (r in (m
      ...
      attr: function (e, t, n) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return void 0 === e.getAttribute
            ...
            : ((1 === o && d.isXMLDoc(e)) ||
                ((t = t.toLowerCase()),
                (i = d.attrHooks[t] || (d.expr.match.bool.test(t) ? yt : vt))),
              void 0 !== n
                ? null === n
      ...
      set: function (e, t, n) {
        return (
          !1 === t
            ? d.removeAttr(e, n)
            : (Tt && wt) || !bt.test(n)
            ? e.setAttribute((!wt && d.propFix[n]) || n, n)
    ...
    toggleClass: function (e, t) {
      ...
      return "boolean" == typeof t && "string" === n
        ...
        : this.each(function () {
            var t, r, i, o;
            if ("string" === n)
              for (r = 0, i = d(this), o = e.match(H) || []; (t = o[r++]); )
                i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
            else
              (void 0 !== e && "boolean" !== n) ||
                ((t = kt(this)) && d._data(this, "__className__", t),
                d.attr(
                  this,
                  "class",
                  t || !1 === e ? "" : d._data(this, "__className__") || ""
                ));
          });
    },
    hasClass: function (e) {
  ...
  d.extend({
    ...
    ajax: function (t, n) {
      ...
      f.hasContent ||
        (f.data &&
          ((o = f.url += (Dt.test(o) ? "&" : "?") + f.data), delete f.data),
        !1 === f.cache &&
          (f.url = Ht.test(o)
            ? o.replace(Ht, "$1_=" + At++)
            : o + (Dt.test(o) ? "&" : "?") + "_=" + At++)),
      f.ifModified &&
        (d.lastModified[o] &&
          T.setRequestHeader("If-Modified-Since", d.lastModified[o]),
  ...
  d.ajaxSetup({
    ...
    d.ajaxPrefilter("json jsonp", function (t, n, r) {
      ...
      if (s || "jsonp" === t.dataTypes[0])
        return (
          (i = t.jsonpCallback = d.isFunction(t.jsonpCallback)
            ? t.jsonpCallback()
            : t.jsonpCallback),
          s
  ...
  (d.fn.load = function (e, t, n) {
    ...
    (d.offset = {
      setOffset: function (e, t, n) {
        ...
        "static" === l && (e.style.position = "relative"),
          ...
          (o = d.css(e, "top")),
          (u = d.css(e, "left")),
          ("absolute" === l || "fixed" === l) && d.inArray("auto", [o, u]) > -1
    ...
    d.each(["top", "left"], function (e, t) {
      d.cssHooks[t] = Ue(f.pixelPosition, function (e, n) {
        if (n)
          return (n = ze(e, t)), Be.test(n) ? d(e).position()[t] + "px" : n;
      });
    }),
